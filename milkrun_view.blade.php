                                ...
                                <div class="table-responsive">
                                    <table id="tbl_milkrun" class="table table-striped table-hover" width="100%">
                                        <thead class="text-center">
                                            <tr>
                                                <th width="5%">#</th>
                                                <th width="15%">DN Number / SJ Number</th>
                                        ...
                                        <tbody id="body_item" style="font-size: 15px; text-align: center;">
...
function loadMilkrunData() {
    $.get("{{ route('milkrun.data') }}", function (data) {
        const table = $('#tbl_milkrun').DataTable();
...
$(document).ready(function () {
    ...
    $('#tbl_milkrun').DataTable({
        ...
        dom: '<"row justify-content-end"<"col-auto"f>>tip'
    });
